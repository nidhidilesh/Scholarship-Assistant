tun the server, open the link from the terminal, you'll see login page in chrome. You can register by clicking on signin. For registration you'll need 'auth_user' table in database which is one of the tables django provides.
